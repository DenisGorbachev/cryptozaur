defmodule Cryptozaur.Drivers.LeverexRest do
  ...
  def get_withdrawals(pid, asset, extra \\ []) do
    GenServer.call(pid, {:get_withdrawals, asset, extra}, @timeout)
  end
  ...
  def handle_call({:get_withdrawals, asset, extra}, _from, state) do
